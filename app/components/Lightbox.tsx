...
export default function Lightbox({ images, isOpen, initialIndex, onClose }: LightboxProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-95 flex items-center justify-center">
            ...
            {/* Desktop: Vertical scrolling layout */}
            <div
                ref={containerRef}
                className="hidden md:block w-[60%] h-[90vh] overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-white scrollbar-track-transparent"
                style={{
            ...
            <div className="md:hidden w-full h-full overflow-x-auto overflow-y-hidden flex snap-x snap-mandatory scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                {images.map((image, index) => (
                    <div
                        key={index}
